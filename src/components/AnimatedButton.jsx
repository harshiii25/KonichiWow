...
const AnimatedButton = ({ onClick, children = "NEXT" }) => {
  return (
    <StyledWrapper>
...
const StyledWrapper = styled.div`
  ...
  .cta {
    ...
    cursor: pointer;
    font-family: "Holtwood One SC", system-ui;
    margin-top: -20px;
  }
  ...
  .cta:hover {
    transition: 0.5s;
    box-shadow: 10px 10px 0 #000000ff;
